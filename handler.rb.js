...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$call', TMP_1 = function ːcall(env) {
      var self = this;

      return [200, $hash2(["Content-Type"], {"Content-Type": "text/plain"}), ["message: Hello", "env: " + (env.$to_s())]];
